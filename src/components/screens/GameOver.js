...
class GameOver extends React.Component {
  ...
  async componentDidMount() {     
    ...
    await AdMobRewarded.setAdUnitID('ca-app-pub-9479991163016134/8471387042'); // Test ID, Replace with your-admob-unit-id
    ...
    return (
      <View style={styles.container}>
        ...
        <AdMobBanner
            ...
            adUnitID="ca-app-pub-9479991163016134/3588863519" // Test ID, Replace with your-admob-unit-id
